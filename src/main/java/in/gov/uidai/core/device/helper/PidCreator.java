...
import in.gov.uidai.core.device.model.DeviceCollectedAuthData.BiometricData;
import in.gov.uidai.core.model.xsd.uid_auth_request_data._1.*;
...
/*	public static in.gov.uidai.core.model.protobuf.auth.Auth.Pid createProtoPid( DeviceCollectedAuthData data) {

		in.gov.uidai.core.model.protobuf.auth.Auth.Pid.Builder pidBuilder = Auth.Pid.newBuilder();
		
		if (data != null) {
			in.gov.uidai.core.model.protobuf.auth.Auth.Demo.Builder demo = Auth.Demo.newBuilder();
			...
			if (data.getName() != null && !data.getName().isEmpty()
				...
				in.gov.uidai.core.model.protobuf.auth.Auth.Pi.Builder pi = Auth.Pi.newBuilder();
				...
				if (data.getDob() != null) {
					in.gov.uidai.core.model.protobuf.auth.Auth.Dob.Builder dob = Auth.Dob
							.newBuilder();
