...
package in.gov.uidai.core.model.xsd.auth.uid_auth_request._1;
 ...
 * generated in the in.gov.uidai.auth.uid_auth_request._1 package.
...
public class ObjectFactory {
    ...
    private final static QName _Auth_QNAME = new QName("http://www.uidai.gov.in/auth/uid-auth-request/1.0", "Auth");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: in.gov.uidai.auth.uid_auth_request._1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.uidai.gov.in/auth/uid-auth-request/1.0", name = "Auth")
