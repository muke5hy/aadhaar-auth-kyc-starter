 ...
 * generated in the in.gov.uidai.auth.otp._1 package.
...
public class ObjectFactory {
    ...
    private final static QName _OtpRes_QNAME = new QName("http://www.uidai.gov.in/auth/otp/1.0", "OtpRes");
    private final static QName _Otp_QNAME = new QName("http://www.uidai.gov.in/auth/otp/1.0", "Otp");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: in.gov.uidai.auth.otp._1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.uidai.gov.in/auth/otp/1.0", name = "OtpRes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.uidai.gov.in/auth/otp/1.0", name = "Otp")
